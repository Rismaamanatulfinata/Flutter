...
class DetailScreenSecond extends StatelessWidget {

  const DetailScreenSecond({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  CircleAvatar(
                    radius: 60,
                    backgroundImage: AssetImage('images/gambar2.png'),
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () => ('https://docs.flutter.io/flutter/services/UrlLauncher-class.html'),
                      ),
                      IconButton(
